    ...
    <div>
      ...
      <el-row style="margin-top: 20px;">
  			<el-col :span="14" :offset="4">
                ...
                <!-- Select 选择器 http://element.eleme.io/#/zh-CN/component/select#option-attributes -->
            ...
            <el-form-item label="上传食品图片">
              <!-- 上传图片 http://element.eleme.io/#/zh-CN/component/upload#upload-shang-chuan -->
              <el-upload
          ...
          <!-- v-model 修改成了:visible.sync http://element.eleme.io/#/zh-CN/component/dialog#dialog-dui-hua-kuang -->
